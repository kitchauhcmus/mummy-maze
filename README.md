...
* **Bước 1:** Giải nén thư mục source code `Mummy_Maze_CodePhantom`.
...
Bash
python main.py
Màn hình Launcher sẽ hiện ra yêu cầu chọn chế độ:
